    ...
    class WriteToExcel
    {
        ...
        public static void writeToExcel(Home home, String source, DateTime date)
        {
            ...
            try
            {
                ...
                worksheet.Cells[x + home.creditGridView.RowCount + 1, y + 1] = home.totalCreditLabel.Text;
                ...
                worksheet.Cells[x + home.debitGridView.RowCount + 1, y + 1] = home.totalDebitLabel.Text;
                ...
                worksheet.Cells[x + home.cashGridView.RowCount + 1, y + 2] = home.totalCashLabel.Text;
                ...
                worksheet.Cells[x + home.cashGridView.RowCount + 2, y + 2] = home.calculatedBalanceLabel.Text;
                ...
                {
                    Console.WriteLine("Printing error: " + printEx.Message);
                }
                ...
                string savePath = workingDirectory + source + "_" + date.ToString("ddMMyy") + ".xls";
